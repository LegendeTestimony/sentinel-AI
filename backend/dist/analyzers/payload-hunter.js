 ...
 */
export function huntPayloads(buffer, fileType) {
    const payloads = [];
 ...
 */
function detectShellcodePatterns(buffer) {
    const payloads = [];
 ...
 */
function detectBase64Blobs(buffer) {
    const payloads = [];
    try {
 ...
 */
function analyzeDecodedData(data) {
    // Check for PE header
 ...
 */
function findEmbeddedPE(buffer) {
    const payloads = [];
 ...
 */
function findSuspiciousEncryptedBlobs(buffer, fileType) {
    const payloads = [];
 ...
 */
function detectEmbeddedScripts(buffer, fileType) {
    const payloads = [];
 ...
 */
function calculatePayloadRisk(payloads) {
 ...
 */
function generatePayloadSummary(payloads, risk) {
    if (payloads.length === 0) {
